const AboutMe = () => {
	return (
	  <section>
		<h2 className="title-font blue-text h2-tag">About Me</h2>
		<p className="white-text p-tag">
		  I am a full-stack web developer with 9 months of working experience. I
		  combine my coding passion with technical skills and fully commit
